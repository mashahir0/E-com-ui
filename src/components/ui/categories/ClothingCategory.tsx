            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              {[1, 2, 3].map((item, index) => (
                <motion.div 
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <div className="w-full h-48 bg-gradient-to-br from-orange-500/30 to-yellow-500/30 rounded-lg mb-4"></div>
                  <h3 className="text-xl font-semibold text-white mb-2">Fashion Item {item}</h3>
                  <p className="text-blue-100">Trendy clothing for every occasion.</p>
                </motion.div>
              ))}
            </div>
          </div>
